...
const ScanSettings$json = const {
  ...
  '2': const [
    ...
    const {'1': 'service_names', '3': 4, '4': 3, '5': 9, '10': 'serviceNames'},
  ],
};

/// Descriptor for `ScanSettings`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scanSettingsDescriptor = $convert.base64Decode('CgxTY2FuU2V0dGluZ3MSKgoRYW5kcm9pZF9zY2FuX21vZGUYASABKAVSD2FuZHJvaWRTY2FuTW9kZRIjCg1zZXJ2aWNlX3V1aWRzGAIgAygJUgxzZXJ2aWNlVXVpZHMSKQoQYWxsb3dfZHVwbGljYXRlcxgDIAEoCFIPYWxsb3dEdXBsaWNhdGVzEiMKDXNlcnZpY2VfbmFtZXMYBCADKAlSDHNlcnZpY2VOYW1lcw==');
@$core.Deprecated('Use periodicScanSettingsDescriptor instead')
const PeriodicScanSettings$json = const {
  '1': 'PeriodicScanSettings',
  '2': const [
    const {'1': 'android_scan_mode', '3': 1, '4': 1, '5': 5, '10': 'androidScanMode'},
    const {'1': 'service_uuids', '3': 2, '4': 3, '5': 9, '10': 'serviceUuids'},
    const {'1': 'allow_duplicates', '3': 3, '4': 1, '5': 8, '10': 'allowDuplicates'},
    const {'1': 'service_names', '3': 4, '4': 3, '5': 9, '10': 'serviceNames'},
    const {'1': 'periodMilliseconds', '3': 5, '4': 1, '5': 5, '10': 'periodMilliseconds'},
    const {'1': 'timeoutMilliseconds', '3': 6, '4': 1, '5': 5, '10': 'timeoutMilliseconds'},
    const {'1': 'dispositionClass', '3': 7, '4': 1, '5': 9, '10': 'dispositionClass'},
  ],
};

/// Descriptor for `PeriodicScanSettings`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List periodicScanSettingsDescriptor = $convert.base64Decode('');
